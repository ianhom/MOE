...
#define PLATFORM_NAME                         "STM32F407VET6_SP1"    /* Platform name */  
...
#define __DEBUG_MODE_PT_DEMO3              __DEBUG_BASIC_INFO
#endif
...
#define TASK_PT_DEMO_LED_TOGGLE        Board_LED_Toggle

#define LED_1                  (1)     /* Led 1 */
#define LED_2                  (2)     /* Led 1 */
