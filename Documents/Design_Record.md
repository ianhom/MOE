...
## 关于写调度/OS
- 对我而言，我很庆幸自己有机会写了MOE，在编写的工程师不断强化嵌入式思想，正如MOE的对外含义“Minds Of Embedded”，个人能力和自信都在默默增加，编写MOE所带来的益处远远超过了MOE本身的实用性。同时，最近（2017年2月）自制调度/OS的小伙伴特别多，能有更多的人一起交流，是件很开心的事。学习他家的设计，也是受益匪浅。
